...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/19 14:36:57 by rreis-de          #+#    #+#             */
/*   Updated: 2022/09/19 14:36:58 by rreis-de         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*   By: rreis-de <rreis-de@student.42lisboa.com>   +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/14 18:41:49 by rreis-de          #+#    #+#             */
/*   Updated: 2022/09/19 14:34:54 by rreis-de         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strcapitalize(char *str)
{
	...
	while (str[j] != '\0')
	{
		if (i == 1 && (str[j] >= 'a' && str[j] <= 'z'))
		{
			str[j] -= 32;
			i = 0;
		}
		else if (str[j] >= '0' && str[i] <= '9')
			i = 0;
		else if (str[j] == ' ' || str[i] == '\t')
			i = 1;
		j++;
